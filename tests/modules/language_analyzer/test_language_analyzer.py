...
def language_analyzer_bad_lang(
    ...
    return language_analyzer_services.language_analyzer.LanguageAnalyzerService(
...
def test_that_language_analyzer_removes_unsupported_languages(
    language_analyzer_bad_lang: language_analyzer_services.language_analyzer.LanguageAnalyzerService,
    folder_path: MagicMock,
):
...
def test_that_language_analyzer_includes_python(
    language_analyzer_python: language_analyzer_services.language_analyzer.LanguageAnalyzerService,
    folder_path: MagicMock,
):
...
def test_that_language_analyzer_displays_warnings(
    language_analyzer_with_warnings: language_analyzer_services.language_analyzer.LanguageAnalyzerService,
    folder_path: MagicMock,
):
