...
class LanguageSupportService:
    ...
    def version_for_language(self, languages: dict[str, float]) -> str:
        """
        ...
        return self.pre_commit_hook.version_for_language(languages)

    def apply_support(self, languages: dict[str, float]) -> LanguageMetadata:
        """
